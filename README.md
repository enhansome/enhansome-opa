...
A curated list of [awesome](https://github.com/sindresorhus/awesome) ⭐ 509,808 | 🐛 106 | 📅 2026-09-02 Open Policy Agent (OPA) related tools, frameworks and articles.
...
* [OPA](https://github.com/open-policy-agent/opa) ⭐ 12,269 | 🐛 301 | 🌐 Go | 📅 2026-09-24 - Open Policy Agent Github repository
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,280 | 🐛 198 | 🌐 Go | 📅 2026-09-21 - Kubernetes admission controller using OPA
* [Conftest](https://github.com/open-policy-agent/conftest) ⭐ 3,270 | 🐛 42 | 🌐 Go | 📅 2026-09-21 - Write tests against structured configuration data
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/python) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - Evaluate Rego policies in Python using Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/go) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - Golang bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
* [Fiber OPA Integration](https://github.com/gofiber/contrib/tree/main/opafiber) ⭐ 306 | 🐛 21 | 🌐 Go | 📅 2026-09-24 - OPA integration for Fiber web framework. Enables to execute Rego policies in the middlewares.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/csharp) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - C# bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/cpp) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - C++ bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [Go SDK](https://github.com/open-policy-agent/opa/tree/main/internal/wasm/sdk) ⭐ 12,269 | 🐛 301 | 🌐 Go | 📅 2026-09-24 - a small Go library for using WebAssembly compiled Open Policy Agent Rego policies
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [Snyk CLI](https://github.com/snyk/snyk) ⭐ 5,664 | 🐛 126 | 🌐 TypeScript | 📅 2026-09-24 - Test Infrastructure as Code source code for security misconfigurations and best practices in the local console. The npm-opa-wasm library is used to run WASM bundle of Rego policies to detect misconfiguration.
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 346 | 🐛 65 | 🌐 Rust | 📅 2026-09-24 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
* [OPA Wasm demo](https://opa-wasm.glitch.me/) - Demonstration of evaluating OPA's Wasm modules in the browser

## Kubernetes

* [Kubescape](https://github.com/armosec/kubescape) ⭐ 11,741 | 🐛 51 | 🌐 Go | 📅 2026-09-24 - Kubescape is tool for scanning Kubernetes clusters for security issues. Kubescape tests (rules) are based completely on OPA. See the regos [here](https://github.com/armosec/regolibrary) ⭐ 133 | 🐛 13 | 🌐 Open Policy Agent | 📅 2026-09-23
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,280 | 🐛 198 | 🌐 Go | 📅 2026-09-21 - A validating and mutating webhook that enforces CRD-based policies executed by OPA for Kubernetes
...
* [Gatekeeper Policy Manager](https://github.com/sighupio/gatekeeper-policy-manager) ⭐ 328 | 🐛 2 | 🌐 Go | 📅 2026-09-23 - Web UI for Gatekeeper policies
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 138 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-24 - Open source AI-powered multi-cluster Kubernetes dashboard with built-in OPA/Gatekeeper policy visualization, real-time compliance monitoring across hybrid edge and cloud environments. CNCF Sandbox project (Apache 2.0)
...
* [OPA Envoy Plugin](https://github.com/open-policy-agent/opa-envoy-plugin) ⭐ 362 | 🐛 17 | 🌐 Go | 📅 2026-09-24 - The OPA Envoy Plugin (compatible with Envoy, Istio, Gloo Edge, more)
...
* [Elasticsearch](https://github.com/open-policy-agent/contrib/tree/master/data_filter_elasticsearch) ⭐ 349 | 🐛 23 | 🌐 Go | 📅 2026-07-16 - OPA-Elasticsearch Data Filtering Example
...
* [Kafka Authorizer](https://github.com/StyraInc/opa-kafka-plugin) ⭐ 64 | 🐛 8 | 🌐 Scala | 📅 2026-09-24 - Kafka authorizer plugin using OPA, with example policies
...
* [Atom](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/atom) ⭐ 12,269 | 🐛 301 | 🌐 Go | 📅 2026-09-24 - Syntax highlighting for the Atom editor
* [TextMate](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/textmate) ⭐ 12,269 | 🐛 301 | 🌐 Go | 📅 2026-09-24 - Syntax highlighting for TextMate
* [Sublime](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/sublime) ⭐ 12,269 | 🐛 301 | 🌐 Go | 📅 2026-09-24 - Syntax highlighting for Sublime
* [Nano](https://github.com/scopatz/nanorc) ⭐ 3,267 | 🐛 120 | 🌐 Shell | 📅 2024-05-27 - Syntax highlighting for Nano
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 38,058 | 🐛 265 | 🌐 Go | 📅 2026-09-24 - Scan your code and artifacts for known vulnerabilities and misconfiguration issues.
* [Infracost](https://github.com/infracost/infracost/) ⭐ 12,533 | 🐛 23 | 🌐 Go | 📅 2026-09-21 - Infracost generates cloud cost estimates for Terraform and integrates with OPA, it can be used to write [cost policies](https://www.infracost.io/docs/features/cost_policies/)
...
* [Pulumi OPA Bridge for CrossGuard](https://github.com/pulumi/pulumi-policy-opa) ⭐ 14 | 🐛 4 | 🌐 Go | 📅 2026-09-24 - This project allows OPA rules to be run in the context of Pulumi's policy system, CrossGuard
...
* [Topaz](https://github.com/aserto-dev/topaz) ⭐ 1,361 | 🐛 12 | 🌐 Go | 📅 2026-09-24 - Topaz is an open-source application authorization project that uses OPA as the decision engine and supports Rego policies.
* [Regal](https://github.com/open-policy-agent/regal) ⭐ 409 | 🐛 140 | 🌐 Go | 📅 2026-09-23 - Regal is a linter for Rego, with the goal of making your Rego magnificent! ([blog](https://www.styra.com/blog/guarding-the-guardrails-introducing-regal-the-rego-linter/))
...
* [ScubaGear](https://github.com/cisagov/ScubaGear/) ⭐ 2,681 | 🐛 231 | 🌐 PowerShell | 📅 2026-09-24 - Using Rego policies to assess the security posture of M365 tenants, by CISA
