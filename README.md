...
A curated list of [awesome](https://github.com/sindresorhus/awesome) ⭐ 504,460 | 🐛 106 | 📅 2026-09-02 Open Policy Agent (OPA) related tools, frameworks and articles.
...
* [OPA](https://github.com/open-policy-agent/opa) ⭐ 12,221 | 🐛 323 | 🌐 Go | 📅 2026-09-09 - Open Policy Agent Github repository
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,274 | 🐛 200 | 🌐 Go | 📅 2026-09-08 - Kubernetes admission controller using OPA
* [Conftest](https://github.com/open-policy-agent/conftest) ⭐ 3,258 | 🐛 52 | 🌐 Go | 📅 2026-09-08 - Write tests against structured configuration data

### Docs

* [Rego Style Guide](https://github.com/StyraOSS/rego-style-guide) ⭐ 206 | 🐛 5 | 📅 2026-06-18 - Style guide for Rego, providing pointers on best practices for policy authoring
...
* [Rego policies](https://github.com/redhat-cop/rego-policies) ⭐ 171 | 🐛 7 | 🌐 Shell | 📅 2026-09-07 - Rego policies from the the Red Hat community of practice
* [Kubescape Rego library](https://github.com/kubescape/regolibrary) ⭐ 132 | 🐛 14 | 🌐 Open Policy Agent | 📅 2026-09-09 - Comprehensive set of Kubernetes policies from Kubescape
...
* [GOPAL](https://github.com/Principled-Evolution/gopal) ⭐ 7 | 🐛 12 | 🌐 Open Policy Agent | 📅 2026-08-31 - 66 Rego policies encoding AI-governance regulations as executable checks: EU AI Act, NIST AI RMF, FERPA/COPPA, fair lending. Versioned under `v1/` with semver guarantees, allow/deny test per policy, `opa check` + Regal in CI.
...
* [Thunx](https://github.com/xenit-eu/thunx) ⭐ 40 | 🐛 1 | 🌐 Java | 📅 2026-09-07 - Thunx is a pluggable ABAC system using OPA, Spring Cloud Gateway and Spring Data REST
...
* [Spring Boot Starter for OPA ABAC](https://github.com/Void3110/spring-boot-starter-opa-abac) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2026-09-06 - Spring-native ABAC authorization backed by OPA: `@OpaPreAuthorize` method security, hierarchical resource authorization, and partial-evaluation → JPA `Specification` data filtering

### Python

* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/python) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - Evaluate Rego policies in Python using Regorus, a fast, lightweight Rego interpreter written in Rust.
* [OPA Python client](https://github.com/Turall/OPA-python-client) ⭐ 67 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - Python client for OPA's REST API
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/go) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - Golang bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
* [Fiber OPA Integration](https://github.com/gofiber/contrib/tree/main/opafiber) ⭐ 306 | 🐛 20 | 🌐 Go | 📅 2026-09-09 - OPA integration for Fiber web framework. Enables to execute Rego policies in the middlewares.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/csharp) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - C# bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/cpp) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - C++ bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [Go SDK](https://github.com/open-policy-agent/opa/tree/main/internal/wasm/sdk) ⭐ 12,221 | 🐛 323 | 🌐 Go | 📅 2026-09-09 - a small Go library for using WebAssembly compiled Open Policy Agent Rego policies
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
* [NPM module](https://github.com/open-policy-agent/npm-opa-wasm/) ⭐ 158 | 🐛 16 | 🌐 JavaScript | 📅 2026-07-10 - a small SDK for using WebAssembly compiled Open Policy Agent Rego policies
...
* [Snyk CLI](https://github.com/snyk/snyk) ⭐ 5,657 | 🐛 136 | 🌐 TypeScript | 📅 2026-09-09 - Test Infrastructure as Code source code for security misconfigurations and best practices in the local console. The npm-opa-wasm library is used to run WASM bundle of Rego policies to detect misconfiguration.
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 345 | 🐛 63 | 🌐 Rust | 📅 2026-09-09 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
* [OPA Wasm demo](https://opa-wasm.glitch.me/) - Demonstration of evaluating OPA's Wasm modules in the browser

## Kubernetes

* [Kubescape](https://github.com/armosec/kubescape) ⭐ 11,724 | 🐛 43 | 🌐 Go | 📅 2026-09-09 - Kubescape is tool for scanning Kubernetes clusters for security issues. Kubescape tests (rules) are based completely on OPA. See the regos [here](https://github.com/armosec/regolibrary) ⭐ 132 | 🐛 14 | 🌐 Open Policy Agent | 📅 2026-09-09
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,274 | 🐛 200 | 🌐 Go | 📅 2026-09-08 - A validating and mutating webhook that enforces CRD-based policies executed by OPA for Kubernetes
...
* [Konstraint](https://github.com/plexsystems/konstraint) ⭐ 394 | 🐛 22 | 🌐 Go | 📅 2025-11-20 - CLI tool for working with templates and constraints when using Gatekeeper
* [Gatekeeper Policy Manager](https://github.com/sighupio/gatekeeper-policy-manager) ⭐ 328 | 🐛 5 | 🌐 Go | 📅 2026-09-02 - Web UI for Gatekeeper policies
* [kube-mgmt](https://github.com/open-policy-agent/kube-mgmt) ⭐ 261 | 🐛 13 | 🌐 Go | 📅 2026-08-27 - Sidecar providing data from Kubernetes to OPA. Includes Helm charts for both projects
* [Red Hat Rego Policies](https://github.com/redhat-cop/rego-policies) ⭐ 171 | 🐛 7 | 🌐 Shell | 📅 2026-09-07 - Red Hat Rego policies collection
* [MagTape](https://github.com/tmobile/magtape) ⭐ 152 | 🐛 27 | 🌐 Python | 📅 2024-04-24 - OPA-based admission controller for policy enforcement
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 133 | 🐛 168 | 🌐 TypeScript | 📅 2026-09-09 - Open source AI-powered multi-cluster Kubernetes dashboard with built-in OPA/Gatekeeper policy visualization, real-time compliance monitoring across hybrid edge and cloud environments. CNCF Sandbox project (Apache 2.0)
...
* [OPA Envoy Plugin](https://github.com/open-policy-agent/opa-envoy-plugin) ⭐ 362 | 🐛 16 | 🌐 Go | 📅 2026-09-09 - The OPA Envoy Plugin (compatible with Envoy, Istio, Gloo Edge, more)
...
* [awesome-terraform-compliance](https://github.com/antonbabenko/awesome-terraform-compliance) ⭐ 143 | 🐛 1 | 📅 2026-07-29 - Curated list of OPA/Rego policy libraries, IaC scanners (Conftest, Regula, Fugue), and compliance resources for Terraform and OpenTofu.
...
* [Atom](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/atom) ⭐ 12,221 | 🐛 323 | 🌐 Go | 📅 2026-09-09 - Syntax highlighting for the Atom editor
* [TextMate](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/textmate) ⭐ 12,221 | 🐛 323 | 🌐 Go | 📅 2026-09-09 - Syntax highlighting for TextMate
* [Sublime](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/sublime) ⭐ 12,221 | 🐛 323 | 🌐 Go | 📅 2026-09-09 - Syntax highlighting for Sublime
...
* [tree-sitter-rego](https://github.com/FallenAngel97/tree-sitter-rego) ⭐ 12 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-18 - Tree-sitter grammar for Rego ([blog](https://decodeapps.pp.ua/blog/post/rego-treesitter))
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,843 | 🐛 269 | 🌐 Go | 📅 2026-09-09 - Scan your code and artifacts for known vulnerabilities and misconfiguration issues.
* [Infracost](https://github.com/infracost/infracost/) ⭐ 12,513 | 🐛 21 | 🌐 Go | 📅 2026-09-09 - Infracost generates cloud cost estimates for Terraform and integrates with OPA, it can be used to write [cost policies](https://www.infracost.io/docs/features/cost_policies/)
...
* [TFLint OPA Ruleset](https://github.com/terraform-linters/tflint-ruleset-opa) ⭐ 86 | 🐛 4 | 🌐 Go | 📅 2026-09-09 - Write custom TFLint rules in Rego
...
* [Topaz](https://github.com/aserto-dev/topaz) ⭐ 1,362 | 🐛 11 | 🌐 Go | 📅 2026-09-09 - Topaz is an open-source application authorization project that uses OPA as the decision engine and supports Rego policies.
* [Regal](https://github.com/open-policy-agent/regal) ⭐ 404 | 🐛 144 | 🌐 Go | 📅 2026-09-09 - Regal is a linter for Rego, with the goal of making your Rego magnificent! ([blog](https://www.styra.com/blog/guarding-the-guardrails-introducing-regal-the-rego-linter/))
* [Open Policy Containers](https://github.com/opcr-io/policy) ⭐ 259 | 🐛 9 | 🌐 Go | 📅 2026-09-02 - Secure software supply chains for OPA policies. Push, pull, tag, test, version, and sign OPA policies.
* [Fregot](https://github.com/fugue/fregot) ⭐ 231 | 🐛 10 | 🌐 Haskell | 📅 2022-06-30 - Alternative REPL implementation for Rego
...
* [ScubaGear](https://github.com/cisagov/ScubaGear/) ⭐ 2,657 | 🐛 232 | 🌐 PowerShell | 📅 2026-09-09 - Using Rego policies to assess the security posture of M365 tenants, by CISA
