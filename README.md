...
A curated list of [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,288 | 🐛 105 | 📅 2026-09-02 Open Policy Agent (OPA) related tools, frameworks and articles.
...
* [OPA](https://github.com/open-policy-agent/opa) ⭐ 12,188 | 🐛 332 | 🌐 Go | 📅 2026-09-02 - Open Policy Agent Github repository
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,274 | 🐛 193 | 🌐 Go | 📅 2026-09-02 - Kubernetes admission controller using OPA
* [Conftest](https://github.com/open-policy-agent/conftest) ⭐ 3,256 | 🐛 53 | 🌐 Go | 📅 2026-08-31 - Write tests against structured configuration data
...
* [Rego policies](https://github.com/redhat-cop/rego-policies) ⭐ 171 | 🐛 5 | 🌐 Shell | 📅 2026-08-31 - Rego policies from the the Red Hat community of practice
* [Kubescape Rego library](https://github.com/kubescape/regolibrary) ⭐ 132 | 🐛 15 | 🌐 Open Policy Agent | 📅 2026-08-31 - Comprehensive set of Kubernetes policies from Kubescape
...
* [Thunx](https://github.com/xenit-eu/thunx) ⭐ 40 | 🐛 1 | 🌐 Java | 📅 2026-08-27 - Thunx is a pluggable ABAC system using OPA, Spring Cloud Gateway and Spring Data REST
...
* [Spring Boot Starter for OPA ABAC](https://github.com/Void3110/spring-boot-starter-opa-abac) ⭐ 3 | 🐛 0 | 🌐 Java | 📅 2026-08-24 - Spring-native ABAC authorization backed by OPA: `@OpaPreAuthorize` method security, hierarchical resource authorization, and partial-evaluation → JPA `Specification` data filtering

### Python

* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/python) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - Evaluate Rego policies in Python using Regorus, a fast, lightweight Rego interpreter written in Rust.
* [OPA Python client](https://github.com/Turall/OPA-python-client) ⭐ 66 | 🐛 0 | 🌐 Python | 📅 2026-08-18 - Python client for OPA's REST API
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/go) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - Golang bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
* [Fiber OPA Integration](https://github.com/gofiber/contrib/tree/main/opafiber) ⭐ 306 | 🐛 28 | 🌐 Go | 📅 2026-09-02 - OPA integration for Fiber web framework. Enables to execute Rego policies in the middlewares.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/csharp) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - C# bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
* [C# SDK](https://github.com/open-policy-agent/opa-csharp) ⭐ 6 | 🐛 11 | 🌐 C# | 📅 2026-08-24 - C# SDK for interacting with OPA ([documentation](https://open-policy-agent.github.io/opa-csharp/))
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/cpp) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - C++ bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [swift-opa](https://github.com/open-policy-agent/swift-opa) ⭐ 36 | 🐛 14 | 🌐 Swift | 📅 2026-09-01 - Swift package for evaluating OPA IR Plans compiled from Rego policies
...
* [Go SDK](https://github.com/open-policy-agent/opa/tree/main/internal/wasm/sdk) ⭐ 12,188 | 🐛 332 | 🌐 Go | 📅 2026-09-02 - a small Go library for using WebAssembly compiled Open Policy Agent Rego policies
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [Rust](https://github.com/matrix-org/rust-opa-wasm) ⭐ 79 | 🐛 13 | 🌐 Rust | 📅 2026-08-24 - A crate to use OPA policies compiled to Wasm.
...
* [Snyk CLI](https://github.com/snyk/snyk) ⭐ 5,654 | 🐛 134 | 🌐 TypeScript | 📅 2026-09-02 - Test Infrastructure as Code source code for security misconfigurations and best practices in the local console. The npm-opa-wasm library is used to run WASM bundle of Rego policies to detect misconfiguration.
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 343 | 🐛 62 | 🌐 Rust | 📅 2026-09-02 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
* [OPA Wasm demo](https://opa-wasm.glitch.me/) - Demonstration of evaluating OPA's Wasm modules in the browser

## Kubernetes

* [Kubescape](https://github.com/armosec/kubescape) ⭐ 11,717 | 🐛 39 | 🌐 Go | 📅 2026-09-02 - Kubescape is tool for scanning Kubernetes clusters for security issues. Kubescape tests (rules) are based completely on OPA. See the regos [here](https://github.com/armosec/regolibrary) ⭐ 132 | 🐛 15 | 🌐 Open Policy Agent | 📅 2026-08-31
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,274 | 🐛 193 | 🌐 Go | 📅 2026-09-02 - A validating and mutating webhook that enforces CRD-based policies executed by OPA for Kubernetes
* [GKE Policy Automation](https://github.com/google/gke-policy-automation) ⭐ 526 | 🐛 5 | 🌐 Go | 📅 2026-08-17 - Tool and policy library for reviewing GKE clusters against best practices
* [Konstraint](https://github.com/plexsystems/konstraint) ⭐ 393 | 🐛 22 | 🌐 Go | 📅 2025-11-20 - CLI tool for working with templates and constraints when using Gatekeeper
* [Gatekeeper Policy Manager](https://github.com/sighupio/gatekeeper-policy-manager) ⭐ 328 | 🐛 5 | 🌐 Go | 📅 2026-08-26 - Web UI for Gatekeeper policies
...
* [Red Hat Rego Policies](https://github.com/redhat-cop/rego-policies) ⭐ 171 | 🐛 5 | 🌐 Shell | 📅 2026-08-31 - Red Hat Rego policies collection
* [MagTape](https://github.com/tmobile/magtape) ⭐ 152 | 🐛 27 | 🌐 Python | 📅 2024-04-24 - OPA-based admission controller for policy enforcement
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 131 | 🐛 44 | 🌐 TypeScript | 📅 2026-09-02 - Open source AI-powered multi-cluster Kubernetes dashboard with built-in OPA/Gatekeeper policy visualization, real-time compliance monitoring across hybrid edge and cloud environments. CNCF Sandbox project (Apache 2.0)
...
* [OPA Envoy Plugin](https://github.com/open-policy-agent/opa-envoy-plugin) ⭐ 362 | 🐛 17 | 🌐 Go | 📅 2026-09-01 - The OPA Envoy Plugin (compatible with Envoy, Istio, Gloo Edge, more)
...
* [Nomad Admission Control Proxy](https://github.com/mxab/nacp) ⭐ 52 | 🐛 6 | 🌐 Go | 📅 2026-09-02 - An admission controller that can be used as a proxy to Nomad's API for mutation and validation with builtin OPA support.

## Terraform

* [awesome-terraform-compliance](https://github.com/antonbabenko/awesome-terraform-compliance) ⭐ 143 | 🐛 0 | 📅 2026-07-29 - Curated list of OPA/Rego policy libraries, IaC scanners (Conftest, Regula, Fugue), and compliance resources for Terraform and OpenTofu.
...
* [Atom](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/atom) ⭐ 12,188 | 🐛 332 | 🌐 Go | 📅 2026-09-02 - Syntax highlighting for the Atom editor
* [TextMate](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/textmate) ⭐ 12,188 | 🐛 332 | 🌐 Go | 📅 2026-09-02 - Syntax highlighting for TextMate
* [Sublime](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/sublime) ⭐ 12,188 | 🐛 332 | 🌐 Go | 📅 2026-09-02 - Syntax highlighting for Sublime
* [Nano](https://github.com/scopatz/nanorc) ⭐ 3,263 | 🐛 119 | 🌐 Shell | 📅 2024-05-27 - Syntax highlighting for Nano
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,744 | 🐛 268 | 🌐 Go | 📅 2026-09-02 - Scan your code and artifacts for known vulnerabilities and misconfiguration issues.
* [Infracost](https://github.com/infracost/infracost/) ⭐ 12,503 | 🐛 17 | 🌐 Go | 📅 2026-09-02 - Infracost generates cloud cost estimates for Terraform and integrates with OPA, it can be used to write [cost policies](https://www.infracost.io/docs/features/cost_policies/)
...
* [Example Terraform policies](https://github.com/Scalr/sample-tf-opa-policies) ⭐ 179 | 🐛 6 | 🌐 Open Policy Agent | 📅 2026-08-19 - Example Terraform policies
* [TFLint OPA Ruleset](https://github.com/terraform-linters/tflint-ruleset-opa) ⭐ 85 | 🐛 3 | 🌐 Go | 📅 2026-09-02 - Write custom TFLint rules in Rego
...
* [Topaz](https://github.com/aserto-dev/topaz) ⭐ 1,361 | 🐛 10 | 🌐 Go | 📅 2026-09-02 - Topaz is an open-source application authorization project that uses OPA as the decision engine and supports Rego policies.
* [Regal](https://github.com/open-policy-agent/regal) ⭐ 402 | 🐛 149 | 🌐 Go | 📅 2026-09-01 - Regal is a linter for Rego, with the goal of making your Rego magnificent! ([blog](https://www.styra.com/blog/guarding-the-guardrails-introducing-regal-the-rego-linter/))
...
* [ScubaGear](https://github.com/cisagov/ScubaGear/) ⭐ 2,653 | 🐛 241 | 🌐 PowerShell | 📅 2026-09-02 - Using Rego policies to assess the security posture of M365 tenants, by CISA
...
* [goast](https://github.com/m-mizutani/goast) ⭐ 76 | 🐛 0 | 🌐 Go | 📅 2026-07-10 - Go AST (Abstract Syntax Tree) based static analysis tool using Rego
