...
A curated list of [awesome](https://github.com/sindresorhus/awesome) ⭐ 501,959 | 🐛 105 | 📅 2026-08-21 Open Policy Agent (OPA) related tools, frameworks and articles.
...
* [OPA](https://github.com/open-policy-agent/opa) ⭐ 12,186 | 🐛 333 | 🌐 Go | 📅 2026-09-01 - Open Policy Agent Github repository
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,273 | 🐛 192 | 🌐 Go | 📅 2026-08-31 - Kubernetes admission controller using OPA
...
* [Kubescape Rego library](https://github.com/kubescape/regolibrary) ⭐ 132 | 🐛 14 | 🌐 Open Policy Agent | 📅 2026-08-31 - Comprehensive set of Kubernetes policies from Kubescape
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/python) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - Evaluate Rego policies in Python using Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/go) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - Golang bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
* [Fiber OPA Integration](https://github.com/gofiber/contrib/tree/main/opafiber) ⭐ 306 | 🐛 25 | 🌐 Go | 📅 2026-08-31 - OPA integration for Fiber web framework. Enables to execute Rego policies in the middlewares.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/csharp) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - C# bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/cpp) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - C++ bindings to Regorus, a fast, lightweight Rego interpreter written in Rust.
...
* [swift-opa](https://github.com/open-policy-agent/swift-opa) ⭐ 36 | 🐛 14 | 🌐 Swift | 📅 2026-08-25 - Swift package for evaluating OPA IR Plans compiled from Rego policies
...
* [Go SDK](https://github.com/open-policy-agent/opa/tree/main/internal/wasm/sdk) ⭐ 12,186 | 🐛 333 | 🌐 Go | 📅 2026-09-01 - a small Go library for using WebAssembly compiled Open Policy Agent Rego policies
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
...
* [Snyk CLI](https://github.com/snyk/snyk) ⭐ 5,654 | 🐛 133 | 🌐 TypeScript | 📅 2026-09-01 - Test Infrastructure as Code source code for security misconfigurations and best practices in the local console. The npm-opa-wasm library is used to run WASM bundle of Rego policies to detect misconfiguration.
* [regorus](https://github.com/microsoft/regorus/tree/main/bindings/wasm) ⭐ 343 | 🐛 61 | 🌐 Rust | 📅 2026-08-31 - Evaluate Rego policies in WASM using Regorus. Try it out at [Regorus Playground](https://anakrish.github.io/regorus-playground/).
* [OPA Wasm demo](https://opa-wasm.glitch.me/) - Demonstration of evaluating OPA's Wasm modules in the browser

## Kubernetes

* [Kubescape](https://github.com/armosec/kubescape) ⭐ 11,715 | 🐛 48 | 🌐 Go | 📅 2026-09-01 - Kubescape is tool for scanning Kubernetes clusters for security issues. Kubescape tests (rules) are based completely on OPA. See the regos [here](https://github.com/armosec/regolibrary) ⭐ 132 | 🐛 14 | 🌐 Open Policy Agent | 📅 2026-08-31
* [Gatekeeper](https://github.com/open-policy-agent/gatekeeper) ⭐ 4,273 | 🐛 192 | 🌐 Go | 📅 2026-08-31 - A validating and mutating webhook that enforces CRD-based policies executed by OPA for Kubernetes
...
* [KubeStellar Console](https://github.com/kubestellar/console) ⭐ 130 | 🐛 39 | 🌐 TypeScript | 📅 2026-09-01 - Open source AI-powered multi-cluster Kubernetes dashboard with built-in OPA/Gatekeeper policy visualization, real-time compliance monitoring across hybrid edge and cloud environments. CNCF Sandbox project (Apache 2.0)
...
* [OPA Envoy Plugin](https://github.com/open-policy-agent/opa-envoy-plugin) ⭐ 362 | 🐛 15 | 🌐 Go | 📅 2026-08-31 - The OPA Envoy Plugin (compatible with Envoy, Istio, Gloo Edge, more)
...
* [Nomad Admission Control Proxy](https://github.com/mxab/nacp) ⭐ 52 | 🐛 5 | 🌐 Go | 📅 2026-08-20 - An admission controller that can be used as a proxy to Nomad's API for mutation and validation with builtin OPA support.
...
* [Atom](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/atom) ⭐ 12,186 | 🐛 333 | 🌐 Go | 📅 2026-09-01 - Syntax highlighting for the Atom editor
* [TextMate](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/textmate) ⭐ 12,186 | 🐛 333 | 🌐 Go | 📅 2026-09-01 - Syntax highlighting for TextMate
* [Sublime](https://github.com/open-policy-agent/opa/tree/master/misc/syntax/sublime) ⭐ 12,186 | 🐛 333 | 🌐 Go | 📅 2026-09-01 - Syntax highlighting for Sublime
...
* [Trivy](https://github.com/aquasecurity/trivy) ⭐ 37,732 | 🐛 265 | 🌐 Go | 📅 2026-09-01 - Scan your code and artifacts for known vulnerabilities and misconfiguration issues.
* [Infracost](https://github.com/infracost/infracost/) ⭐ 12,500 | 🐛 17 | 🌐 Go | 📅 2026-08-31 - Infracost generates cloud cost estimates for Terraform and integrates with OPA, it can be used to write [cost policies](https://www.infracost.io/docs/features/cost_policies/)
...
* [TFLint OPA Ruleset](https://github.com/terraform-linters/tflint-ruleset-opa) ⭐ 85 | 🐛 3 | 🌐 Go | 📅 2026-09-01 - Write custom TFLint rules in Rego
...
* [Topaz](https://github.com/aserto-dev/topaz) ⭐ 1,360 | 🐛 11 | 🌐 Go | 📅 2026-08-31 - Topaz is an open-source application authorization project that uses OPA as the decision engine and supports Rego policies.
* [Regal](https://github.com/open-policy-agent/regal) ⭐ 402 | 🐛 148 | 🌐 Go | 📅 2026-09-01 - Regal is a linter for Rego, with the goal of making your Rego magnificent! ([blog](https://www.styra.com/blog/guarding-the-guardrails-introducing-regal-the-rego-linter/))
* [Open Policy Containers](https://github.com/opcr-io/policy) ⭐ 259 | 🐛 9 | 🌐 Go | 📅 2026-08-19 - Secure software supply chains for OPA policies. Push, pull, tag, test, version, and sign OPA policies.
...
* [ScubaGear](https://github.com/cisagov/ScubaGear/) ⭐ 2,652 | 🐛 241 | 🌐 PowerShell | 📅 2026-09-01 - Using Rego policies to assess the security posture of M365 tenants, by CISA
